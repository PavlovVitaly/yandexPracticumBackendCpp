...
private:
    ...
    std::vector< RequestHandlerNode<ActivatorType, HandlerType> > rh_storage_ = {
        ...
        RequestHandlerNode<ActivatorType, HandlerType>(GetPlayersListActivator,
                                                        ...
                                                        InvalidMethodHandler),
        RequestHandlerNode<ActivatorType, HandlerType>(GetGameStateEmptyAuthorizationActivator,
                                                        {{http::verb::get, EmptyAuthorizationHandler}},
                                                        InvalidMethodHandler),
        RequestHandlerNode<ActivatorType, HandlerType>(GetGameStateUnknownTokenActivator,
                                                        {{http::verb::get, UnknownTokenHandler}},
                                                        InvalidMethodHandler),
